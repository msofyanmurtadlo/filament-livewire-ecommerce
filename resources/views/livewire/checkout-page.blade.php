                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input wire:model='first_name'
                                    class="w-full @error('first_name')
                                        border-red-500
                                    @enderror rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                        ...
                        <div class="mt-4">
                            ...
                            <input wire:model='street_address'
                                class="w-full @error('street_address')
                                        border-red-500
                                    @enderror rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
            ...
            <div class="md:col-span-12 lg:col-span-4 col-span-12">
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="flex justify-between mb-2 font-bold">
                        ...
                        <span>
                            {{ Str::of(Number::currency($grand_total, 'IDR', 'id'))->replace(',00', '') }}
                        </span>
                    </div>
                    <div class="flex justify-between mb-2 font-bold">
                        <span>
                        ...
                        <span>
                            {{ Str::of(Number::currency(0, 'IDR', 'id'))->replace(',00', '') }}
                        </span>
                    </div>
                    <div class="flex justify-between mb-2 font-bold">
                        <span>
                            ...
                            <li class="py-3 sm:py-4">
                                <div class="flex items-center">
                                    ...
                                    <div
                                        ...
                                        {{ Str::of(Number::currency($ci['total_amount'], 'IDR', 'id'))->replace(',00', '') }}
                                    </div>
                                </div>
                            </li>
                        @endforeach
