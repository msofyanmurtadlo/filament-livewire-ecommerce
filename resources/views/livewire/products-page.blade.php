                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            <div class="font-semibold">
                                {{ Str::of(Number::currency($price_range, 'IDR', 'id'))->replace(',00', '') }}</div>
                            <input type="range" wire:model.live='price_range'
                                class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer"
                                max="10000000" value="300000" step="10000">
                            <div class="flex justify-between ">
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Str::of(Number::currency(10000, 'IDR', 'id'))->replace(',00', '') }}</span>
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Str::of(Number::currency(10000000, 'IDR', 'id'))->replace(',00', '') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key='{{ $product->id }}'>
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span
                                                class="text-green-600 dark:text-green-600">{{ Str::of(Number::currency($product->price, 'IDR', 'id'))->replace(',00', '') }}</span>
                                        </p>
                                    </div>
